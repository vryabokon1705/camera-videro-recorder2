...
#include "CameraVideoRecorder2.hh"
...
// Private data class.
class streamer::CameraVideoRecorderPrivate
{
  ...
  if (this->recordVideo)
  {
    ...
    else
    {
      ...
      if (this->recordVideoFormat != "mp4" && this->recordVideoFormat!= "ogv" &&
          this->recordVideoFormat != "avi" && this->recordVideoFormat != "v4l2")
      {
...
//////////////////////////////////////////////////
CameraVideoRecorder2::CameraVideoRecorder2()
  : System(), dataPtr(std::make_unique<CameraVideoRecorderPrivate>())
{
}

//////////////////////////////////////////////////
void CameraVideoRecorder2::Configure(
...
//////////////////////////////////////////////////
void CameraVideoRecorder2::PostUpdate(const UpdateInfo &_info,
...
GZ_ADD_PLUGIN(streamer::CameraVideoRecorder2,
                    gz::sim::System,
                    streamer::CameraVideoRecorder2::ISystemConfigure,
                    streamer::CameraVideoRecorder2::ISystemPostUpdate)

// Add plugin alias so that we can refer to the plugin without the version
// namespace
GZ_ADD_PLUGIN_ALIAS(streamer::CameraVideoRecorder2, "streamer::CameraVideoRecorder2")
